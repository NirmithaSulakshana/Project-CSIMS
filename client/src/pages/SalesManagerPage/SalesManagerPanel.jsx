...
import UpdateSalesManagerItems from "./updateItems"
import SalesManagerPacking from "./packing"
import SalesManagerOrders from "./orders"
    ...
    return (
      ...
      <div style={{ display: '', height: "100%", width: "100%", margin: "0px" }}>
        ...
        <List style={{ width: '100%', 
         ...
         <hr/>
        <ListItem button onClick={() => setSelectedSection('updateStock')} style={{ textAlign: 'center' }}>
